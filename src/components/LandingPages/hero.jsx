    ...
    <>
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 pt-12 container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-[#FF6B35] to-[#FF6B35]/70 bg-clip-text text-transparent">
            Temukan & Bagikan
            <br />
            Kuliner Favoritmu
          </h1>
          ...
          <div>
            ...
            {/* <Button
              size="lg"
              //   onClick={onAddClick}
              className="bg-[#FF6B35] hover:bg-[#E85C2A] text-lg !px-8 py-6 hover:shadow-xl transition-all duration-300 cursor-pointer"
            >
